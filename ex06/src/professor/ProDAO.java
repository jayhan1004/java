...
public class ProDAO { 
	...
	public void update(ProVO vo) {
		try {
			...
			ps.execute();
		}catch(Exception e) {System.out.println("교수수정:" +e.toString());}
	}
	...
	public void delete(String pcode) {
		try {
			...
			ps.execute();
		}catch(Exception e) {System.out.println("교수삭제:" + e.toString());}
	}
	...
	public ProVO read(String pcode) {
		...
		}catch(Exception e) {System.out.println("교수조회:" + e.toString());}
		return vo;
	}
	...
	public int getCode() {
		...
		try {
			...
			PreparedStatement ps = con.prepareStatement(sql);
			ResultSet rs = ps.executeQuery();
			if(rs.next()) {code=rs.getInt("code");
			}
			
			
		}catch(Exception e) {System.out.println("새로운코드:" + e.toString());}
		return code;
	}	
	...
	public void insert (ProVO vo) {
		...
		}catch(Exception e) {System.out.println("교수등록:" +e.toString());}
	}
	...
	public ArrayList<ProVO> list(){
		...
		}catch(Exception e) {System.out.println("교수목록:" + e.toString());}
		return array;
	}
}
